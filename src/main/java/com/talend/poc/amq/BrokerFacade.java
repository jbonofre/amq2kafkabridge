...
public class BrokerFacade {
    ...
    public BrokerFacade(int httpPort, String jettyConfig, int tcpPort, long maxFrameSize, String syncopeAccess) throws Exception {
        ...
        if (jettyConfig != null) {
            brokerService.addConnector("http://0.0.0.0:" + httpPort + "?jetty.config=" + jettyConfig + "&wireFormat.maxFrameSize=" + maxFrameSize);
        } else {
            brokerService.addConnector("http://0.0.0.0:" + httpPort + "?wireFormat.maxFrameSize=" + maxFrameSize);
        }
        brokerService.addConnector("tcp://0.0.0.0:" + tcpPort + "?wireFormat.maxFrameSize=" + maxFrameSize);
